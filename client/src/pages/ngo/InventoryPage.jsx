...
const categoryOptions = ['food', 'medicine', 'shelter', 'water', 'clothing', 'other'];
      ...
      <div style={styles.shell}>
        <div style={styles.header}>
          <div style={styles.headerBlock}>
            ...
            <p style={styles.subtitle}>
              Track supplies, connect stock to active camps, and catch shortages before they slow down relief work.
            </p>
            <div style={styles.nav}>
              <Link to="/ngo" style={styles.navLink(false)}>Dashboard</Link>
              <Link to="/ngo/inventory" style={styles.navLink(true)}>Inventory</Link>
              <Link to="/ngo/camps" style={styles.navLink(false)}>Camps</Link>
          ...
          <div style={styles.userBlock}>
            ...
            <div style={{ color: 'var(--text-secondary)', fontSize: '0.88rem', marginTop: '6px' }}>
              Supply desk for active relief operations
            </div>
        ...
        <div style={styles.statsGrid}>
          <div style={styles.statCard}>
            ...
            <div style={styles.statHint}>Distinct supply records across your NGO</div>
          </div>
          <div style={styles.statCard}>
          ...
          <div style={styles.statCard}>
            ...
            <div style={styles.statHint}>Items at or below their warning threshold</div>
          </div>
          <div style={styles.statCard}>
            <div style={styles.statLabel}>Camp Linked</div>
            <div style={styles.statValue}>{assignedToCampCount}</div>
            <div style={styles.statHint}>Inventory entries tied to a relief camp</div>
          </div>
        </div>
        ...
        <div style={styles.contentGrid}>
          <div style={styles.panel}>
            <div style={styles.panelTitleRow}>
              <h2 style={styles.panelTitle}>{editingId ? 'Edit Item' : 'Add Inventory'}</h2>
            </div>
            <p style={styles.panelText}>
              Keep quantities, units, and camp allocation updated so shortage alerts stay accurate.
            </p>
            ...
            <form onSubmit={handleSubmit} style={styles.form}>
              ...
              <div className="field">
                ...
                <select id="camp" name="camp" value={form.camp} onChange={handleChange}>
          ...
          <div style={styles.panel}>
            <div style={styles.panelTitleRow}>
              <div>
                ...
                <div style={{ color: 'var(--text-secondary)', fontSize: '0.88rem' }}>
                  {loading ? 'Refreshing data...' : `${items.length} inventory records`}
                </div>
              </div>
              {!!lowStockItems.length && (
                <div style={styles.badge('danger')}>{lowStockItems.length} low stock</div>
              )}
            </div>
            ...
            {loading ? (
              ...
              <div style={styles.emptyState}>
                No inventory has been added yet. Create your first supply record from the panel on the left.
              </div>
            ) : (
                  ...
                  <div key={item._id} style={styles.itemCard(item.isLow)}>
                    <div style={styles.itemTop}>
                      ...
                      <div style={styles.badgeRow}>
                        ...
                        {item.isLow && <div style={styles.badge('danger')}>Low stock</div>}
                      </div>
                    </div>
                    ...
                    <div style={styles.itemGrid}>
                      ...
                      <div>
                        ...
                        <div style={styles.itemCellValue}>{item.lowStockThreshold}</div>
                      </div>
                      <div>
                        <div style={styles.itemCellLabel}>Camp</div>
                        <div style={styles.itemCellValue}>{item.camp?.name || 'Unassigned'}</div>
                      </div>
                    </div>

                    <div style={styles.rowActions}>
                      <button type="button" style={styles.smallBtn} onClick={() => handleEdit(item)}>
                        Edit item
                      </button>
                      <button type="button" style={styles.deleteBtn} onClick={() => handleDelete(item._id)}>
                        Delete item
                      </button>
                    </div>
                  </div>
